...
| **Smart Contract Service** (EVM-compatible) | **Implemented (optional):** `contracts/BlitzwingEscrow.sol` — x402 can pay escrow; orchestrator `release()` after inference. See [contracts/README.md](../contracts/README.md). |
